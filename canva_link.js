...
// canva.com/design/<id> — id буквенно-цифровой С ПОДЧЁРКИВАНИЯМИ (живой пример
// 06.09: DAHUVbQF_Tc — класс [A-Za-z0-9] без '_' молча не матчил ссылку). Ловим
// ссылку внутри любого текста (Ира часто пишет «вот макет ... https://...»), с
// www и без, с query-параметрами (?feature=share&utm=...) и без завершающего слэша.
const CANVA_DESIGN_RE = /https?:\/\/(?:www\.)?canva\.com\/design\/([A-Za-z0-9_-]+)(?:[/?#]|$)/g;
